...
- **ISO/IEC 27040**: Guía para la seguridad de almacenamiento.
...
- **DBAN (Darik's Boot and Nuke)**: Software gratuito para borrado de discos duros.
- **Eraser**: Aplicación de código abierto para Windows que permite sobrescritura de archivos y espacio libre.
- **Blancco Drive Eraser**: Solución comercial con certificaciones para uso empresarial.
...
- **Software de Código Abierto**: Repositorios en GitHub para herramientas de borrado seguro.