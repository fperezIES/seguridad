...
[Unidades capacidad binarias](ttps://es.wikipedia.org/wiki/Prefijo_binario)
...
![](../img/02/partesHDD.png)<!-- .element height="80%" -->
...
![](../img/02/SSD1.png)<!-- .element width="80%" -->

--
### Discos de estado sólido (SDD)

![](../img/02/SSD3.png)<!-- .element height="80%" -->

--

### Discos de estado sólido (SDD)

![](../img/02/SSD2.png)<!-- .element height="80%" -->
...
![RAID 0](../img/02/Raid0.png)<!-- .element height="30%" -->
...
![RAID 1](../img/02/Raid1.png)<!-- .element height="30%" -->
...
![RAID 5](../img/02/Raid5.png)<!-- .element height="30%" -->
...
![Hot Spare](../img/02/RaidSpare.jpg)<!-- .element height="30%" -->
...
![](../img/02/NAS2.png)<!-- .element height="80%" -->

--

### NAS

![](../img/02/NAS1.jpg)<!-- .element height="80%" -->
...
![Red NAS](../img/02/redNAS.png)<!-- .element height="70%" -->
...
![SAN HITACHI](../img/02/SAN_HITACHI.PNG)<!-- .element height="80%" -->

--
[SAN DELL](https://www.dell.com/en-us/dt/learn/data-storage/san-storage.htm)

![SAN DELL](../img/02/SAN_DELL.jpg)<<!-- .element height="80%" -->stretch" -->
...
![Red SAN](../img/02/redSAN.png)<!-- .element height="80%" -->
...
![](../img/02/resilio.png)<!-- .element height="80%" -->
