...
| _[gigabyte](https://es.wikipedia.org/wiki/Gigabyte "Gigabyte")_ (GB)                                                                   | 109                                                                                                         | _[gibibyte](https://es.wikipedia.org/wiki/Gibibyte "Gibibyte")_ (GiB)                     | 2^30    |
...
* Los fabricantes indican los tamaños de los discos duros usando multiplicadores en base 10 para que los números sean más grandes, pero en informática se mide el tamaño de los ficheros usando los multiplicadores en base 2.
	- Un TiB son 1024 x 1024 x 1024 bytes = 1,073,741,824 bytes
	- El fabricante usa 1TB = 1,000,000,000


Así que cuando instalamos el disco vemos la siguiente capacidad:
		(1,000,000,000 / 1,073,741,824) = 0.9313 TiB, o 931.3 GiB
...
### Velocidades típicas HDD sobre SATA III

- **HDD a 5,400 RPM** (revoluciones por minuto):    
    - **Velocidad de transferencia promedio:** Entre **80 MB/s y 120 MB/s**.
- **HDD a 7,200 RPM**:    
    - **Velocidad de transferencia promedio:** Entre **120 MB/s y 160 MB/s**.
- **HDD a 10,000 RPM** (menos común en el mercado doméstico):
    - **Velocidad de transferencia promedio:** Entre **160 MB/s y 200 MB/s**.
...
- PCIe 4.0 = PCIe 3.0 x 2 
- PCIe 5.0 = PCIe  4.0 x 2
...
![](../img/02/partesHDD.png)<!-- .element width="70%" -->
...
![](img/samsung_ssd_sata.png)<!-- .element width="70%" -->

--

### Discos de estado sólido (SDD) NVMe PCIe

![](../img/02/SSD2.png)<!-- .element width="70%" -->
...
![](../img/SDD_NVMe_WD.jpg)<!-- .element width="70%" -->
...
![RAID 5](../img/02/Raid5.png)<!-- .element width="50%" -->
...
![RAID 6](../img/02/Raid6.png)<!-- .element: width=60% -->
...
![Hot Spare](../img/02/RaidSpare.jpg)<!-- .element width="50%" -->
...
![RAID 10](../img/02/Raid10.png)<!-- .element width="30%" -->
...
![RAID 50](../img/02/Raid50.jpg)<!-- .element width="50%" -->
...
![](../img/02/NAS1.jpg)<!-- .element width="80%" -->
...
![SAN HITACHI](../img/02/SAN_HITACHI.PNG)<!-- .element width="70%" -->

--
[SAN DELL](https://www.dell.com/en-us/dt/learn/data-storage/san-storage.htm)

![SAN DELL](../img/02/SAN_DELL.jpg)<!-- .element width="70%" -->
...
![Red SAN](../img/02/redSAN.png)<!-- .element width="70%" -->
