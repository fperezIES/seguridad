...
* Combinaciones de discos que permiten aumentar el rendimiento, la disponibilidad, y la capacidad.
...
![](../img/HDD_WD_gold.jpeg)<!-- .element width="50%" -->
...
![](img/samsung_ssd_sata.png)<!-- .element width="50%" -->
...
![](../img/SDD_NVMe_WD.jpg)<!-- .element width="50%" -->
...
![RAID 5](../img/02/Raid5.png)<!-- .element width="40%" -->
...
![SAN HITACHI](../img/02/SAN_HITACHI.PNG)<!-- .element width="40%" -->
