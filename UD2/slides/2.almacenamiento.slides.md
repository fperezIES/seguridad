...
![](../img/02/partesHDD.png)<!-- .element height="60%" -->
...
![RAID 0](../img/02/Raid0.png)<!-- .element height="15%" -->
...
![RAID 10](../img/02/Raid10.png)<!-- .element height="30%" -->
...
![RAID 50](../img/02/Raid50.jpg)<!-- .element height="30%" -->
...
![](../img/02/NAS2.png)<!-- .element height="60%" -->
...
![SAN HITACHI](../img/02/SAN_HITACHI.PNG)<!-- .element height="70%" -->

--
[SAN DELL](https://www.dell.com/en-us/dt/learn/data-storage/san-storage.htm)

![SAN DELL](../img/02/SAN_DELL.jpg)<!-- .element height="70%" -->
...
![Red SAN](../img/02/redSAN.png)<!-- .element height="60%" -->
