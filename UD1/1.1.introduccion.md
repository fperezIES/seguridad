...
![Triada CIA](img/01/CID.png)

<!--img src="img/01/CID.png" alt="Triada CIA" width="50%"/-->
...
Para lograr alta disponibilidad, se utilizan diversas técnicas, como la redundancia de hardware y software, la replicación de datos, el uso de equilibradores de carga, y la implementación de mecanismos de failover que aseguren que, en caso de fallo de uno de los componentes, otro pueda tomar su lugar sin interrumpir el servicio.
