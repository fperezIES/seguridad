...
El **Delegado de Protección de Datos (DPO)** es una figura clave en la normativa de protección de datos. S

u función principal es garantizar que las organizaciones cumplan con las leyes de protección de datos como el RGPD y la LOPDGDD.
