...
<!--![CIA](../img/01/CIA.png)<!-- .element: class="r-stretch"  height=30%-->
...
* Medidas  para proteger los **elementos tangibles** de una organización:
	* hardware, instalaciones y personal
...
- **Autenticación multifactor (MFA)**: como contraseñas, tokens físicos, o datos biométricos , se reduce la posibilidad de acceso no autorizado.
