...
![Carcassonne](../img/01/ciudadela.jpg){.r-stretch}
...
![Capas de protección de un sistema informático](../img/01/defensa_profundiad.png){.r-stretch}
...
* reduciendo la probabilidad de que una amenaza explote una vulnerabilidad 
...
![Interrelación de conceptos](../img/01/elementos_riesgo.png){.r-stretch}
