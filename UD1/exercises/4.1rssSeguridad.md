...
- **INCIBE-CERT** (Instituto Nacional de Ciberseguridad de España)
    ...
    - RSS: https://www.incibe-cert.es/feed/rss
...
- **CCN-CERT** (Centro Criptológico Nacional)
    ...
    - RSS: https://www.ccn-cert.cni.es/feed/rss.html
...
- **NIST National Vulnerability Database (NVD)**
    ...
    - RSS: [https://nvd.nist.gov/feeds/xml/cve/misc/nvd-rss.xml](https://nvd.nist.gov/feeds/xml/cve/misc/nvd-rss.xml)
...
- **CERT-EU (Computer Emergency Response Team for the EU institutions)**
    ...
    - RSS: [https://cert.europa.eu/rss/alerts.xml](https://cert.europa.eu/rss/alerts.xml)
