...
- Permite firma y no repudio
Inconvenientes:
- Claves grandes: computacionalmente costosa.
 ...
 **Funcionamiento**
1. **Generación de claves**: Dos primos grandes y sus productos.
2. **Cifrado**: Con la clave pública del destinatario.
3. **Descifrado**: Con la clave privada correspondiente.
...
- **Cifrado de claves privadas** con cifrado simétrico y contraseñas fuertes.
- **MFA**: Múltiples factores de autenticación para acceder a las claves.
...
Para saber si el servidor es quien dice ser:
- Cliente envía un desafío: texto en claro
- Sevidor: cifra el desafío con su clave privada (similar a firma)
- Cliente: verifica identidad descifrando con la clave pública y comparando el texto 
...
![](../img/04/hibrida.png)<!-- .element width="80%" -->
